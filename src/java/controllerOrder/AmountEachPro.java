 ...
 * @author Admin
 */
@WebServlet(name = "AmountEachPro", urlPatterns = {"/amountP"})
public class AmountEachPro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            int idP = Integer.parseInt(idP_);
            int Amount = Integer.parseInt(amount_);
            dao.UpdateProductOfCart(idP, Amount);
